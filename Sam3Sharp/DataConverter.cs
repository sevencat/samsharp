...
public abstract unsafe class DataConverter
{
...
#pragma warning disable  3019
	...
	public static DataConverter LittleEndian => BitConverter.IsLittleEndian ? CopyConv : SwapConv;

	public static DataConverter BigEndian => BitConverter.IsLittleEndian ? SwapConv : CopyConv;
	...
	static bool PackOne(PackContext b, object oarg)
	{
		...
		switch (b.description[b.i])
		{
			...
			case 'b':
				b.Add([Convert.ToByte(oarg)]);
				break;

			case 'c':
				b.Add([(byte)(Convert.ToSByte(oarg))]);
				break;
	...
	static void PutBytesLE(byte* dest, byte* src, int count)
	{
		int i = 0;
	...
	static void PutBytesBE(byte* dest, byte* src, int count)
	{
		int i = 0;
	...
	static void PutBytesNative(byte* dest, byte* src, int count)
	{
		int i = 0;
	...
	public static double DoubleFromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 8)
	...
	public static float FloatFromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 4)
	...
	public static long Int64FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 8)
	...
	public static ulong UInt64FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 8)
	...
	public static int Int32FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 4)
	...
	public static uint UInt32FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 4)
	...
	public static short Int16FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 2)
	...
	public static ushort UInt16FromNative(byte[] data, int index)
	{
		if (data == null)
			throw new ArgumentNullException(nameof(data));
		if (data.Length - index < 2)
	...
	static byte[] GetBytesPtr(byte* ptr, int count)
	{
	...
	static byte[] GetBytesSwap(bool swap, byte* ptr, int count)
	{
		byte[] ret = new byte [count];
